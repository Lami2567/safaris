...
export const ENV = {
  ...
  // Database
  DATABASE_URL: process.env.DATABASE_URL || 'postgres://safaris_user:safaris_secure_password@localhost:5432/safaris_db',
  
  // Redis
  REDIS_URL: process.env.REDIS_URL || 'redis://localhost:6379',
  
  // Security
  JWT_SECRET: process.env.JWT_SECRET || 'safaris_super_secret_jwt_key_uganda_2026',
  JWT_EXPIRES_IN: process.env.JWT_EXPIRES_IN || '7d',
  REFRESH_TOKEN_SECRET: process.env.REFRESH_TOKEN_SECRET || 'safaris_refresh_token_secret_uganda_2026',
